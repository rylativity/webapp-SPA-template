...
COPY ./openresty_conf/proxy.conf /etc/nginx/proxy.conf
COPY ./openresty_conf/nginx.conf /etc/nginx/nginx.conf
...
COPY ./openresty_conf/default.conf.template /etc/nginx/default.conf.template
COPY ./openresty_conf/access.lua.template /etc/nginx/access.lua.template
